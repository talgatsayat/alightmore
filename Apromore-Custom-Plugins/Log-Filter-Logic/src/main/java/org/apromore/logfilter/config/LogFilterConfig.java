 ...
 * #L%
 */
package org.apromore.logfilter.config;
...
public class LogFilterConfig {
    ...
    @Bean
    @Primary
    public LogFilterService logFilterService() {
        return new LogFilterImpl();
    }

    @Bean
    public LogFilterCriterionFactory logFilterCriterionFactory() {
        return new LogFilterCriterionFactoryImpl();
    }
} 